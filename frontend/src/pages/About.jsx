    ...
    <div className='h-[80%] flex flex-col border-t-2 mt-2 gap-10'>
        ...
        <div className='flex flex-col sm:flex-row sm:w-full gap-10'>
            ...
            <div className='text-gray-600 mt-8 flex flex-col gap-10'>
                ...
                <p className='sm:w-[80%]'>Our mission at WearSphere is to empower customers with choice, convenience, and confidence. We're dedicated to providing a seamless shopping experience that exceeds expectations, from browsing and ordering to delivery and beyond.</p>
            </div>
        </div>
        <div className='mt-10 mb-8'>
            ...
            <div className='flex flex-col sm:flex-row mt-6 bg-gray-50'>
